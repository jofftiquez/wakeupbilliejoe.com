  ...
  v-app(dark)#home
    ...
    v-layout(column)
      v-flex(xs12 md6 offset-md3).pa-2
        <h1 class="titleh1">Privacy policy</h1>
        ...
        <h2 class="titleh2">Collection of personal information</h2>
        ...
        <h2 class="titleh2">Collection of non-personal information</h2>
        ...
        <h2 class="titleh2">Managing personal information</h2>
        ...
        <h2 class="titleh2">Use of collected information</h2>
        ...
        <h2 class="titleh2">Information security</h2>
        ...
        <h2 class="titleh2">Data breach</h2>
        ...
        <h2 class="titleh2">Acceptance of this policy</h2>
